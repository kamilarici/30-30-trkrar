...
// api servisi olan dokuman sayfasına gir

// dokuman sayfasını incele
// 1- api parametre alıyor mu
// 2- parametrelerin özellikleri neler
// 3- hangi formalar kabul edilyor.
// 4- api free mi ?
// 5- api security key içeriyor mu ? (tokey ID)
